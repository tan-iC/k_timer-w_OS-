...
static __STK_UNIT __stack_TASK1[__TCOUNT_STK_UNIT(386)];
static __STK_UNIT __stack_TASK2[__TCOUNT_STK_UNIT(386)];
...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	{TA_HLNG | TA_ACT, (VP_INT)(( VP_INT ) 1), (FP)(task), INT_PRIORITY(8), __TROUND_STK_UNIT(386), __stack_TASK1, TA_NULL, (FP)(NULL)},
	{TA_HLNG | TA_ACT, (VP_INT)(( VP_INT ) 2), (FP)(task), INT_PRIORITY(8), __TROUND_STK_UNIT(386), __stack_TASK2, TA_NULL, (FP)(NULL)},
