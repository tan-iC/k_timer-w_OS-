...
static __STK_UNIT __stack_LED3_TASK[__TCOUNT_STK_UNIT(386)];
...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	{TA_HLNG | TA_ACT, (VP_INT)(( VP_INT ) 0), (FP)(led_task), INT_PRIORITY(8), __TROUND_STK_UNIT(386), __stack_LED1_TASK, TA_NULL, (FP)(NULL)},
	{TA_HLNG | TA_ACT, (VP_INT)(( VP_INT ) 1), (FP)(led_task), INT_PRIORITY(8), __TROUND_STK_UNIT(386), __stack_LED3_TASK, TA_NULL, (FP)(NULL)},
